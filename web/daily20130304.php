...
<div class="container">
  <header>
    ...
    <div class="graduation">
    	<p class="action_orange">A quest a day, keeps the dole queue away.</p>
    </div>
     	...
     	<div class="content_area_activity_chooser">
        	<h1>Daily Option</h1>&nbsp;<br>
            	<div style="margin-left:20px;">
                	Today's task is all about getting the kind of information you need. <br>&nbsp;<br>

                    <span class="action_orange">The Quest: Read all about it.</span><br>&nbsp;<br>
                    Your quest, should you choose to accept it, is to subscribe to the <a href="http://eandt.theiet.org/">Engineering & Technology</a> magazine or subscribe to the <a href="http://www.mcvuk.com/">MCV</a> or <a href="http://www.develop-online.net/">Develop</a> email newsletters.<br>&nbsp;<br>Keeping up to date with the industry news can help you spot opportunities before the competition.  PLUS - you might realise your skills are suited for jobs you never even considered.  E& T Magazine is free, as are the Develop & MCV newsletters.
                    <p>&nbsp;<br></p>
					...
					<p>
                    	<br>&nbsp;<br>
                    	<a href="submit_daily_task.php?id=20130304"><span class="save_changes" style="float:left;">Click here if you did this.</span></a>
                    </p>			
                </div>
