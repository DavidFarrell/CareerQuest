     	...
     	<div class="content_area_activity_chooser">
        	<h1>Daily Option</h1>&nbsp;<br>
            	<div style="margin-left:20px;">
                	This task is about increasing your awareness of the industry.<br>&nbsp;<br>

                    <span class="action_orange">The Quest: A little birdy told me...</span><br>&nbsp;<br>
                    Social media like Twitter is no longer just something you use with your friends.<br>
                    Almost all games companies have a Twitter account and it is VERY common for them to promote jobs there.<br>
                    Even if they're not advertising, keeping up with who is doing what can give you the kind of knowledge you need.<br>
                    Using <a href="http://www.twitter.com">Twitter</a>, follow at least 5 games companies you haven't been following before.  If you're not sure how to find them, look <a href="http://bit.ly/13COyh1">here</a>.
                    <p>&nbsp;<br></p>
					...
					<p>
                    	<br>&nbsp;<br>
                    	<a href="submit_daily_task.php?id=20130305"><span class="save_changes" style="float:left;">Click here if you did this.</span></a>
                    </p>			
                </div>
